...
<template>
    ...
    <div class="page-content-wrapper border">
		...
		<div v-if="departmentNeedsSummary?.length" class="row mb-4" dir="rtl">
			<div class="col-12">
				<div class="card border">
					<div class="card-header d-flex justify-content-between align-items-center">
						<h5 class="mb-0">احتياجات الأقسام</h5>
						<Link :href="route('department-plan.index')" class="btn btn-sm btn-outline-primary">خطة القسم</Link>
					</div>
					...
					<div class="card-body p-4">
						...
						<div class="d-sm-flex justify-content-between align-items-center">
							...
							<div class="d-sm-flex align-items-center mb-1 mb-sm-0">
								<!-- Avatar -->
								<div class="avatar avatar-md flex-shrink-0">
									<img class="avatar-img rounded-circle" src="/front/theme1/images/avatar/05.jpg" alt="avatar">
								</div>
								<!-- Info -->
								<div class="ms-0 ms-sm-2 mt-2 mt-sm-0">

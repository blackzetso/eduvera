        ...
        <main>
            ...
            <section class="pt-0">
                ...
                <div class="container-fluid px-0">
                    <div class="bg-blue h-100px h-md-200px rounded-0" style="background:url('/front/theme1/images/pattern/04.png') no-repeat center center; background-size:cover;">
                    </div>
                </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <!-- Image -->
                                                                    <div class="w-60px">
                                                                        <img src="/front/theme1/images/courses/4by3/08.jpg" class="rounded" alt="">
                                                                    </div>
                                                                    <!-- Title -->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <!-- Image -->
                                                                    <div class="w-60px">
                                                                        <img src="/front/theme1/images/courses/4by3/10.jpg" class="rounded" alt="">
                                                                    </div>
                                                                    <!-- Title -->
                                                                    <h6 class="mb-0 ms-2 table-responsive-title">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <!-- Image -->
                                                                    <div class="w-60px">
                                                                        <img src="/front/theme1/images/courses/4by3/02.jpg" class="rounded" alt="">
                                                                    </div>
                                                                    <!-- Title -->
                                                                    <h6 class="mb-0 ms-2 table-responsive-title">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <!-- Image -->
                                                                    <div class="w-60px">
                                                                        <img src="/front/theme1/images/courses/4by3/04.jpg" class="rounded" alt="">
                                                                    </div>
                                                                    <!-- Title -->
                                                                    <h6 class="mb-0 ms-2 table-responsive-title">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <!-- Image -->
                                                                    <div class="w-60px">
                                                                        <img src="/front/theme1/images/courses/4by3/06.jpg" class="rounded" alt="">
                                                                    </div>
                                                                    <!-- Title -->
                                                                    <h6 class="mb-0 ms-2 table-responsive-title">

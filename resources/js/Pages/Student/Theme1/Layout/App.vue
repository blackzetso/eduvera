            ...
            <nav class="navbar navbar-expand-xl">
                <div class="container-fluid px-3 px-xl-5">
                    ...
                    <Link class="navbar-brand" :href="route('home')">
                        <img class="light-mode-item navbar-brand-item" src="/front/theme1//images/logo.svg" alt="logo">
                        <img class="dark-mode-item navbar-brand-item" src="/front/theme1//images/logo-light.svg" alt="logo">
                    </Link>
                    <!-- Logo END -->
                    ...
                    <div class="navbar-collapse w-100 collapse" id="navbarCollapse">
                                            ...
                                            <div class="row p-4">
                                                ...
                                                <div class="col-xl-6 col-xxl-4 mb-4 mb-xl-0">
                                                    ...
                                                    <div class="d-flex mb-4 position-relative">
                                                        <img src="/front/theme1//images/client/uni-logo-01.svg" class="icon-md" alt="">
                                                        <div class="ms-3">
                                                    ...
                                                    <!-- Dropdown item -->
                                                    <div class="d-flex mb-4 position-relative">
                                                        <img src="/front/theme1//images/client/uni-logo-02.svg" class="icon-md" alt="">
                                                        <div class="ms-3">
                                                    ...
                                                    <!-- Dropdown item -->
                                                    <div class="d-flex mb-4 position-relative">
                                                        <img src="/front/theme1//images/client/uni-logo-03.svg" class="icon-md" alt="">
                                                        <div class="ms-3">
                                                    ...
                                                    <div class="d-flex position-relative">
                                                        <img src="/front/theme1//images/client/uni-logo-04.svg" class="icon-md" alt="">
                                                        <div class="ms-3">
                        ...
                        <ul class="navbar-nav navbar-nav-scroll me-auto">
                            ...
                            <li class="nav-item dropdown">
                                <Link class="nav-link active" :href="route('home')"  >Home</Link>
                            </li>
                            <li class="nav-item dropdown">
                                <Link class="nav-link active" :href="route('lessons')"  >Lessons</Link>
                            </li>
                            <li class="nav-item dropdown">
                                <Link class="nav-link active d-flex align-items-center gap-1" :href="route('student.live-streams.index')">
                                    <span class="live-nav-dot"></span>Live
                                </Link>
                            </li>
                            <li class="nav-item dropdown">
                                <Link class="nav-link active" :href="route('teachers')"  >Teachers</Link>
                            </li>
                            <li class="nav-item dropdown">
                                <Link class="nav-link active" :href="route('blog')"  >Blog</Link>
                            </li>
                        </ul>
                        <!-- Nav Main menu END -->
                    ...
                    <div v-if="user">
                        ...
                        <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
                            ...
                            <li>
                            <Link class="dropdown-item" href="/help">
                            ...
                            <div class="bg-light dark-mode-switch theme-icon-active d-flex align-items-center p-1 rounded mt-2">
                                ...
                                <i class="bi bi-sun fa-fw me-1"></i> Light
                                </button>
                                <button type="button" class="btn btn-sm mb-0" data-bs-theme-value="dark">
                                <i class="bi bi-moon-stars fa-fw me-1"></i> Dark
                                </button>
                                <button type="button" class="btn btn-sm mb-0 active" data-bs-theme-value="auto">
                                <i class="bi bi-circle-half fa-fw me-1"></i> Auto
                                </button>
                            </div>
                            </li>
                    ...
                    <!-- If guest -->
                    <div style="width: 260px;" v-else>
                        <Link :href="route('login')" class="btn  btn-danger-soft me-2 mb-4 mb-sm-0">Login</Link>
                        <Link :href="route('register')" class="btn  btn-danger-soft me-2 mb-4 mb-sm-0">Register</Link>
                    </div>
                    <!-- Profile END -->
                </div>
            </nav>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-3">
                        ...
                        <a class="me-0" href="index.html">
                            <img class="light-mode-item h-40px" src="/front/theme1/images/logo.svg" alt="logo">
                            <img class="dark-mode-item h-40px" src="/front/theme1/images/logo-light.svg" alt="logo">
                        </a>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="row g-2 mt-2">
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-6">
                                <a href="#"> <img src="/front/theme1/images/client/google-play.svg" alt=""> </a>
                            </div>
                            <!-- App store button -->
                            <div class="col-6 col-sm-4 col-md-3 col-lg-6">
                                <a href="#"> <img src="/front/theme1/images/client/app-store.svg" alt="app-store"> </a>
                            </div>
                        </div> <!-- Row END -->
                    </div>
                    <!-- Widget 3 END -->
                                    ...
                                    <li class="list-inline-item">
                                        ...
                                        <div class="dropup mt-0 text-center text-sm-end">
                                            ...
                                            <ul class="dropdown-menu min-w-auto" aria-labelledby="languageSwitcher">
                                                <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="/front/theme1/images/flags/uk.svg" alt="">English</a></li>
                                                <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="/front/theme1/images/flags/gr.svg" alt="">German </a></li>
                                                <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="/front/theme1/images/flags/sp.svg" alt="">French</a></li>
                                            </ul>
                                        </div>
                                    </li>
...
@keyframes live-pulse {
    0%, 100% { opacity: 1; box-shadow: 0 0 0 0 rgba(220,53,69,.6); }
    50%       { opacity: .7; box-shadow: 0 0 0 4px rgba(220,53,69,0); }
}
</style>

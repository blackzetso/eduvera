					...
					<div class="col-xl-3 col-lg-6 col-md-6">
						<div class="card_dash">
							...
							<div class="card_dash_right">
								<img src="{{ asset('admin/theme1/images/dashboard/achievement.svg') }}" alt="">
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-lg-6 col-md-6">
						<div class="card_dash">
							...
							<div class="card_dash_right">
								<img src="{{ asset('admin/theme1/images/dashboard/graduation-cap.svg') }}" alt="">
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-lg-6 col-md-6">
						<div class="card_dash">
							...
							<div class="card_dash_right">
								<img src="{{ asset('admin/theme1/images/dashboard/online-course.svg') }}" alt="">
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-lg-6 col-md-6">
						<div class="card_dash">
							...
							<div class="card_dash_right">
								<img src="{{ asset('admin/theme1/images/dashboard/knowledge.svg') }}" alt="">
							</div>
						</div>
					</div>
					<div class="col-md-12">
							...
							<div class="la5lo1">
								<div class="owl-carousel courses_performance owl-theme">
									<div class="item">
										<div class="fcrse_1">
											<a href="#" class="fcrse_img">
												<img src="{{ asset('admin/theme1/images/courses/img-1.jpg') }}" alt="">
									...
									<div class="item">
										<div class="fcrse_1">
											<a href="#" class="fcrse_img">
												<img src="{{ asset('admin/theme1/images/courses/img-2.jpg') }}" alt="">
												<div class="course-overlay"></div>
											</a>
											<div class="fcrse_content">
												<div class="vdtodt">
									...
									<div class="item">
										<div class="fcrse_1">
											<a href="#" class="fcrse_img">
												<img src="{{ asset('admin/theme1/images/courses/img-3.jpg') }}" alt="">
												<div class="course-overlay"></div>
											</a>
											<div class="fcrse_content">
												<div class="vdtodt">
							...
							<div class="la5lo1">
								<div class="owl-carousel edututs_news owl-theme">
									<div class="item">
										<div class="fcrse_1">
											<a href="#" class="fcrse_img">
												<img src="{{ asset('admin/theme1/images/courses/news-1.jpg') }}" alt="">
											</a>
											<div class="fcrse_content">
									...
									<div class="item">
										<div class="fcrse_1">
											<a href="#" class="fcrse_img">
												<img src="{{ asset('admin/theme1/images/courses/news-2.jpg') }}" alt="">
											</a>
											<div class="fcrse_content">
										...
										<li>
											<a href="index.html">
												<div class="footer_logo">
													<img src="{{ asset('admin/theme1/images/logo1.svg') }}" alt="">
												</div>
											</a>
										</li>
										<li>

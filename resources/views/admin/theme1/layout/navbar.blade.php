<header class="header clearfix">
		...
		<div class="main_logo" id="logo">
			<a href="index.html"><img src="{{ asset('admin/theme1/images/logo.svg') }}" alt=""></a>
			<a href="index.html"><img class="logo-inverse" src="{{ asset('admin/theme1/images/ct_logo.svg') }}" alt=""></a>
		</div>
		<div class="search120">
			<div class="ui search">
			...
			<ul>
					...
					<div class="dropdown-menu dropdown_ms drop-down">
						<a href="#" class="channel_my item">
							<div class="profile_link">
								<img src="{{ asset('admin/theme1/images/left-imgs/img-6.jpg') }}" alt="">
						...
						<a href="#" class="channel_my item">
							<div class="profile_link">
								<img src="{{ asset('admin/theme1/images/left-imgs/img-5.jpg') }}" alt="">
								<div class="pd_content">
									<h6>Joy Dua</h6>
						...
						<a href="#" class="channel_my item">
							<div class="profile_link">
								<img src="{{ asset('admin/theme1/images/left-imgs/img-8.jpg') }}" alt="">
								<div class="pd_content">
									<h6>Jass</h6>
				...
				<li class="dropdown-noti">
					...
					<div class="dropdown-menu dropdown_mn drop-down">
						<a href="#" class="channel_my item">
							<div class="profile_link">
								<img src="{{ asset('admin/theme1/images/left-imgs/img-1.jpg') }}" alt="">
								<div class="pd_content">
									<h6>Rock William</h6>
						...
						<a href="#" class="channel_my item">
							<div class="profile_link">
								<img src="{{ asset('admin/theme1/images/left-imgs/img-2.jpg') }}" alt="">
								<div class="pd_content">
									<h6>Jassica Smith</h6>
						...
						<a href="#" class="channel_my item">
							<div class="profile_link">
								<img src="{{ asset('admin/theme1/images/left-imgs/img-9.jpg') }}" alt="">
								<div class="pd_content">
				...
				<li class="profile-dropdown">
					<a href="#" class="opts_account" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
						<img src="{{ asset('admin/theme1/images/hd_dp.jpg') }}" alt="">
					</a>

...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('front/theme1/vendor/tiny-slider/tiny-slider.css') }}">
...
<!-- Header START -->
@include('front.theme1.layout.navbar')
<!-- Header END -->
...
<!-- =======================
Footer START -->
@include('front.theme1.layout.footer')
<!-- =======================
Footer END -->
...
<!-- Vendors -->
<script src="{{ asset('front/theme1/vendor/tiny-slider/tiny-slider.js') }}"></script>

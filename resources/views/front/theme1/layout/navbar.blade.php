	...
	<nav class="navbar navbar-expand-xl">
		<div class="container-fluid px-3 px-xl-5">
			...
			<a class="navbar-brand" href="index.html">
				<img class="light-mode-item navbar-brand-item" src="{{ asset('front/theme1//images/logo.svg') }}" alt="logo">
				<img class="dark-mode-item navbar-brand-item" src="{{ asset('front/theme1//images/logo-light.svg') }}" alt="logo">
			</a>
			<!-- Logo END -->
									...
									<div class="row p-4">
										...
										<div class="col-xl-6 col-xxl-4 mb-4 mb-xl-0">
											...
											<div class="d-flex mb-4 position-relative">
												<img src="{{ asset('front/theme1//images/client/uni-logo-01.svg') }}" class="icon-md" alt="">
												<div class="ms-3">
											...
											<!-- Dropdown item -->
											<div class="d-flex mb-4 position-relative">
												<img src="{{ asset('front/theme1//images/client/uni-logo-02.svg') }}" class="icon-md" alt="">
												<div class="ms-3">
											...
											<!-- Dropdown item -->
											<div class="d-flex mb-4 position-relative">
												<img src="{{ asset('front/theme1//images/client/uni-logo-03.svg') }}" class="icon-md" alt="">
												<div class="ms-3">
											...
											<div class="d-flex position-relative">
												<img src="{{ asset('front/theme1//images/client/uni-logo-04.svg') }}" class="icon-md" alt="">
												<div class="ms-3">
						...
						<div class="dropdown-menu dropdown-menu-end" data-bs-popper="none">
							<div class="row p-4">
								...
								<div class="col-xl-6 col-xxl-3 mb-3">
									...
									<hr>
									<!-- Image -->
									<img src="{{ asset('front/theme1//images/element/14.svg') }}" alt="">

									<!-- Download button -->
									<div class="row g-2 justify-content-center mt-3">
										<!-- Google play store button -->
										<div class="col-6 col-sm-4 col-xxl-6">
											<a href="#"> <img src="{{ asset('front/theme1//images/client/google-play.svg') }}" class="btn-transition" alt="google-store"> </a>
										</div>
										<!-- App store button -->
										<div class="col-6 col-sm-4 col-xxl-6">
											<a href="#"> <img src="{{ asset('front/theme1//images/client/app-store.svg') }}" class="btn-transition" alt="app-store"> </a>
										</div>
									</div>
								</div>
								...
								<div class="col-12">
									<div class="alert alert-success alert-dismissible fade show mt-2 mb-0 rounded-3" role="alert">
										...
										<div class="avatar avatar-xs me-2">
											<img class="avatar-img rounded-circle" src="{{ asset('front/theme1//images/avatar/09.jpg') }}" alt="avatar">
										</div>
										<!-- Info -->
            ...
            @auth
                <div class="dropdown ms-1 ms-lg-0">
                    <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
                        <img class="avatar-img rounded-circle" src="{{ asset('front/theme1//images/avatar/01.jpg') }}" alt="avatar">
                    </a>
                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
                        ...
                        <li class="px-3 mb-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="avatar me-3">
                                    <img class="avatar-img rounded-circle shadow" src="{{ asset('front/theme1//images/avatar/01.jpg') }}" alt="avatar">
                                </div>
                                <div>
                        ...
                        <li>
                            <button form="logout" class="dropdown-item bg-danger-soft-hover" href="#"><i class="bi bi-power fa-fw me-2"></i>Sign Out</button>
            ...
            @else
                <a href="{{ route('login') }}" class="btn pr-25 btn-danger-soft me-2 mb-4 mb-sm-0"> login </a>
                <a href="{{ route('register') }}" class="btn pr-25 btn-danger-soft me-2 mb-4 mb-sm-0"> Register </a>
            @endauth
			<!-- Profile START -->
		</div>
	</nav>
